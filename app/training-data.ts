...
export const workouts: Workout[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "pallof-b", name: "Pallof press", prescription: "8 reps each side", sets: 2, restSeconds: 45, side: "Both sides", cues: ["Keep the pelvis square", "Exhale as the hands move away", "Resist rotation"] },
    ],
  },
  {
